...
// Test that arrow functions don't have arguments object
var testArguments = () => {
    try {
        return arguments;
    } catch (e) {
...
// Arrow functions inherit arguments from enclosing scope (may be module arguments in Node.js)
if (typeof result === "object" || result === "no arguments") {
    // Both behaviors are acceptable: inheriting parent arguments or having none
    console.log("Arrow function arguments behavior verified");
} else {
    throw new Error("Unexpected arrow function arguments behavior");
}
